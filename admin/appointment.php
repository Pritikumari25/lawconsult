...
<h1 style="text-align:center;color:black;">Booking Appointment</h1>
...
if($conn==true)	
{
 ...
 if(mysqli_num_rows($x)>0)
 {
	...
	{
		$a++;
	echo "<tr><td>$a</td><td>".$row["name"]."</td><td>".$row["email"]."</td><td>".$row["sub"]."</td>
	<td>".$row["msg"]."</td><td><a href='../codes/delcon.php/?v=".$row["email"]."'><span class='fa fa-trash'></span></a></td></tr>";	
	}
 }
 else
 {
	 echo "<tr><td colspan='5'>No Record Available into Database</td></tr>";
 }
}
?>
</table>
